...
Versão do Relatório: alfa 0.1.2

Data: `r format(Sys.time(), '%d/%m/%y')`

Amostra: Este laudo é referente à amostra pair-end de eDNA com identificador `r params$sample`, que foi sequenciada e analisada em metabarcoding por cruzamento com um banco de dados de mitogenomas conhecidos.
